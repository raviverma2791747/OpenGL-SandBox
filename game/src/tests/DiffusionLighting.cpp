...
namespace test
{
    DiffusionLightingCube::DiffusionLightingCube() :
        ...
        m_look(0, 0, 0)
    {
        ...
        m_shader = std::make_unique<Shader>("Res/shaders/DiffusionLightingCube.shader");
        m_shader->Bind();
    ...
    void  DiffusionLightingCube::OnUpdate(float deltaTime)
    {

    }
    void  DiffusionLightingCube::OnRender()
    {
    ...
    void  DiffusionLightingCube::OnImGuiRender()
    {
        ImGui::Text("Cube A");
